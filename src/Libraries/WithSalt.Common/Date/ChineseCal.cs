...
namespace WithSalt.Common.Date
{
    public class ChineseCal
    {
        #region 内部结构
        /// <summary>
        /// 阳历
        ...
        public ChineseCal(DateTime dt)
        {
            ...
            //计算两天的基本差距
            TimeSpan ts = _date - ChineseCal.MinDay;
            offset = ts.Days;
        ...
        public ChineseCal(int cy, int cm, int cd, bool leapMonthFlag)
        {
