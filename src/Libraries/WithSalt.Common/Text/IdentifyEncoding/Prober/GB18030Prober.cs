...
using WithSalt.Common.Text.IdentifyEncoding.Prober.ContextAnalysis;
using WithSalt.Common.Text.IdentifyEncoding.Prober.DistributionAnalysis;
using WithSalt.Common.Text.IdentifyEncoding.Prober.StateMachine;

namespace WithSalt.Common.Text.IdentifyEncoding.Prober
{
    /// <summary>
