...
namespace DNCS.Data.Entity.Extensions
{
    ...
    /// </summary>
    public static class DbTableViewExtensions
    {
        ...
        /// </summary>
        public static bool UseUpperCase { get; set; } = false;
        /// <summary>
        ...
        /// </summary>
        public static string IQueryTypeConfigurationTypeStr = typeof(IEntityTypeConfiguration<>).FullName;

        /// <summary>
        /// 使用DbSet名称为数据库表名称
        /// </summary>
        public static bool UseDbSetNameToTableName { get; set; } = false;

        /// <summary>
        /// 使用DbQuery名称作为数据库视图名称
        /// </summary>
        public static bool UseDbQueryNameToViewName { get; set; } = false;
            ...
            where TDbContext : DbContext
        {
            ...
            foreach (var dbQuery in allDbQuery)
            {
                ...
                builder.Entity(dbQueryType, (queryTypeBuilder) =>
                {
        ...
        /// <param name="schema"></param>
        /// <returns></returns>
        public static EntityTypeBuilder SetViewNameAndAllCloumName(
          this EntityTypeBuilder builder, string tableName = null, string schema = null)
        {
